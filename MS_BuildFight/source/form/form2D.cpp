...
// 初期化
//=============================================================================
HRESULT Cform2D::Init2(LPDIRECT3DDEVICE9 pDevice, LPDIRECT3DTEXTURE9 pFileName, D3DXVECTOR3 pos, D3DXVECTOR3 rot, float width, float height)
{
	m_pDevice = pDevice;
...
void Cform2D::SetTexture(LPDIRECT3DTEXTURE9 pTex)
{
	//if (m_pD3DTex != NULL)m_pD3DTex->Release();
	m_pD3DTex = pTex;
}
