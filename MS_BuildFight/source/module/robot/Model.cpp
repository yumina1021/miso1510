...
{
	"data/MODELNIGHT/body.x",		// [0]体
	"data/MODELNIGHT/head.x",		// [1]頭
	"data/MODELNIGHT/arm_r.x",		// [2]右腕
	"data/MODELNIGHT/hand_r.x",		// [3]右手
	"data/MODELNIGHT/finger_r.x",	// [3]右指
	"data/MODELNIGHT/arm_l.x",		// [4]左腕
	"data/MODELNIGHT/hand_l.x",		// [5]左手
	"data/MODELNIGHT/finger_l.x",	// [5]左指
	"data/MODELNIGHT/leg_r.x",		// [6]右腿
	"data/MODELNIGHT/foot_r.x",		// [7]右足
	"data/MODELNIGHT/leg_l.x",		// [8]左腿
	"data/MODELNIGHT/foot_l.x",		// [9]左足

	"data/MODELGUN/body.x",	// [0]体
	"data/MODELGUN/head.x",	// [1]頭
	"data/MODELGUN/arm_r.x",	// [2]右腕
	"data/MODELGUN/hand_r.x",	// [3]右手
	"data/MODELGUN/finger_r.x",	// [3]右指
	"data/MODELGUN/arm_l.x",	// [4]左腕
	"data/MODELGUN/hand_l.x",	// [5]左手
	"data/MODELGUN/finger_l.x",	// [5]左指
	"data/MODELGUN/leg_r.x",	// [6]右腿
	"data/MODELGUN/foot_r.x",	// [7]右足
	"data/MODELGUN/leg_l.x",	// [8]左腿
	"data/MODELGUN/foot_l.x",	// [9]左足

	"data/MODELGUN2/body.x",	// [0]体
	"data/MODELGUN2/head.x",	// [1]頭
	"data/MODELGUN2/arm_r.x",	// [2]右腕
	"data/MODELGUN2/hand_r.x",	// [3]右手
	"data/MODELGUN2/finger_r.x",	// [3]右指
	"data/MODELGUN2/arm_l.x",	// [4]左腕
	"data/MODELGUN2/hand_l.x",	// [5]左手
	"data/MODELGUN2/finger_l.x",	// [5]左指
	"data/MODELGUN2/leg_r.x",	// [6]右腿
	"data/MODELGUN2/foot_r.x",	// [7]右足
	"data/MODELGUN2/leg_l.x",	// [8]左腿
	"data/MODELGUN2/foot_l.x",	// [9]左足

	"data/MODELGUN3/body.x",	// [0]体
	"data/MODELGUN3/head.x",	// [1]頭
	"data/MODELGUN3/arm_r.x",	// [2]右腕
	"data/MODELGUN3/hand_r.x",	// [3]右手
	"data/MODELGUN3/finger_r.x",	// [3]右指
	"data/MODELGUN3/arm_l.x",	// [4]左腕
	"data/MODELGUN3/hand_l.x",	// [5]左手
	"data/MODELGUN3/finger_l.x",	// [5]左指
	"data/MODELGUN3/leg_r.x",	// [6]右腿
	"data/MODELGUN3/foot_r.x",	// [7]右足
	"data/MODELGUN3/leg_l.x",	// [8]左腿
	"data/MODELGUN3/foot_l.x",	// [9]左足

	"data/MODELGUN0/body.x",	// [0]体
	"data/MODELGUN0/head.x",	// [1]頭
	"data/MODELGUN0/arm_r.x",	// [2]右腕
	"data/MODELGUN0/hand_r.x",	// [3]右手
	"data/MODELGUN0/finger_r.x",	// [3]右指
	"data/MODELGUN0/arm_l.x",	// [4]左腕
	"data/MODELGUN0/hand_l.x",	// [5]左手
	"data/MODELGUN0/finger_l.x",	// [5]左指
	"data/MODELGUN0/leg_r.x",	// [6]右腿
	"data/MODELGUN0/foot_r.x",	// [7]右足
	"data/MODELGUN0/leg_l.x",	// [8]左腿
	"data/MODELGUN0/foot_l.x",	// [9]左足
};
//=============================================================================
// コンストラクタ
//=============================================================================
