...
// コンストラクタ
//=============================================================================
CDome :: CDome(int nPriority) : Cform3D(nPriority)
{
}
//=============================================================================
// デストラクタ
...
// CDome生成
//=============================================================================
CDome *CDome::Create(LPDIRECT3DDEVICE9 pDevice,D3DXVECTOR3 pos,D3DXVECTOR3 rot)
{
	CDome *pformDome;

	pformDome = new CDome();
	pformDome->Init(pDevice);
	pformDome->SetPos(pos);
	pformDome->SetRot(rot);
...
// 初期化
//=============================================================================
HRESULT CDome::Init(LPDIRECT3DDEVICE9 pDevice)
{
	m_pDevice = pDevice;
